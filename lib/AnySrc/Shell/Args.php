...
class Args
{
   ...
   /*
   function __construct($argstring, $blacklist=null, $encoding_check=false) {
   ...
   */
   ...
   protected function __construct($argv)
   {
      if(!is_array($argv))
      {
         throw new Exception("argv is not a array");
      }
   ...
   public static function fromString($argstring, $blacklist=null, $encoding_check=false)
   {
      $tempargs = explode(" ", $argstring);
      $temp = array();
      $index = 0;
